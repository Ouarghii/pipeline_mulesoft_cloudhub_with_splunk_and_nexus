...
if [ -f settings.xml ]; then
    ...
    org_id=$(curl -X GET "https://anypoint.mulesoft.com/accounts/api/me" -H "Authorization: Bearer 90256dcb-da24-4657-b194-497349c5f568" -H "Content-Type: application/json" | jq -r ".user.organization.id")
