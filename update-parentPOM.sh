...
if [ -f settings.xml ]; then
    ...
    org_id=$(curl -X GET "https://anypoint.mulesoft.com/accounts/api/me" -H "Authorization: Bearer f657793e-f340-4e69-9dd5-362116abac47" -H "Content-Type: application/json" | jq -r ".user.organization.id")
