...
if [ -f settings.xml ]; then
    ...
    org_id=$(curl -X GET "https://anypoint.mulesoft.com/accounts/api/me" -H "Authorization: Bearer 0f3758b1-e909-465b-8271-4cf26b79b832" -H "Content-Type: application/json" | jq -r ".user.organization.id")
