...
if [ -f settings.xml ]; then
    ...
    org_id=$(curl -X GET "https://anypoint.mulesoft.com/accounts/api/me" -H "Authorization: Bearer 2b94a2c5-61f3-4875-9700-cfcd93654ddc" -H "Content-Type: application/json" | jq -r ".user.organization.id")
