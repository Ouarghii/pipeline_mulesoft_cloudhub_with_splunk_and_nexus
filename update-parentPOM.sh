...
if [ -f settings.xml ]; then
    ...
    org_id=$(curl -X GET "https://anypoint.mulesoft.com/accounts/api/me" -H "Authorization: Bearer 2c1cf13d-5fc2-4a1f-8512-ba7d8f38083c" -H "Content-Type: application/json" | jq -r ".user.organization.id")
